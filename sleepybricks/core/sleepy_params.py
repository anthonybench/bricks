"""sleepybricks' slice of the shared "sleepy utils" configuration.
...
sleepybricks the shorthand is ``bricks``.
...
DEFAULT_PARAMS: dict[str, Any] = {
    ...
    "bricks_env_emojis": {"dev": "👩‍💻", "stg": "🔧", "us": "🇺🇸"},
    "bricks_display_names": {"dev": "Development", "stg": "Staging", "us": "United States"},
}
...
DEFAULT_PARAMS_SNIPPET = """# sleepybricks
bricks_table_style: simple
bricks_serverless_warehouse_name: <env>_serverless_warehouse
bricks_env_emojis:
  dev: "👩‍💻"
